...
mixIn(GitRemoteResolver, GitResolver);
...
GitRemoteResolver.prototype._checkout = function () {
    ...
    reporter = throttle(function (data) {
        var lines;
